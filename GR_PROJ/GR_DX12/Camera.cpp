...
void Camera::LookAtLH(glm::vec3 eye, glm::vec3 center, glm::vec3 up)
{
	...
	m_Rotation = glm::quatLookAtLH(forwardDir, up);
}
...
{	
	{
		...
		if (g_Input->GetMouseButton(0))
		{
			...
			float xTheta = deltaMove.x / g_iWidth * 2 * 3.1415927f * 0.05f;
			float yTheta = deltaMove.y / g_iHeight * 2 * 3.1415927f * 0.05f;
